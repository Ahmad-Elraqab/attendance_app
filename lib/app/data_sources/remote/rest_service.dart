...
class NewestRestService {
  factory NewestRestService({required String baseUrl}) {
    _singleton.tokenDio = Dio(BaseOptions(baseUrl: baseUrl));
    _singleton.dio = createDio(baseUrl);
    return _singleton;
  }
  ...
  NewestRestService._internal();

  static final _singleton = NewestRestService._internal();
